...
export const ChatInputBar: React.FC<ChatInputBarProps> = ({
  ...
  const quickPrompts = [
    { label: '🇳🇵 नेपालका ७ प्रदेश', query: 'नेपालका ७ वटा प्रदेश र राजधानीको बारेमा बताउ' },
    { label: '🏔️ ८००० मिटरका हिमाल', query: 'नेपालमा रहेका ८ हजार मिटरभन्दा अग्ला ८ हिमालहरू कुन कुन हुन्?' },
    { label: '📚 शिक्षा एआई: नेपाली व्याकरण', query: 'नेपाली व्याकरणको शब्दवर्ग (पदवर्ग) सम्झाउ' },
    { label: '🔬 प्रकाश संश्लेषण के हो?', query: 'प्रकाश संश्लेषण (Photosynthesis) भनेको के हो?' },
    { label: '🌍 सौर्यमण्डलका ८ ग्रह', query: 'सौर्यमण्डलका ८ वटा ग्रहहरू कुन कुन हुन्?' },
    { label: '⚡ न्यूटनका ३ नियम', query: 'न्यूटनका चाल सम्बन्धी तीन नियमहरू के के हुन्?' },
