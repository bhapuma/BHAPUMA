...
export function evaluateSmartKnowledge(rawText: string, context?: {
  ...
  if (exactWakeWords.includes(lower)) {
    const greetings = [
      'हजुर दाजु! म भपुम तयार छु, भन्नुहोस् के मद्दत गरूँ वा के सिकाऊँ?',
      'हजुर! म सुन्दैछु, आज्ञा गर्नुहोस् दाजु। म नेपाल, पढाइ र संसारको जुनसुकै विषयमा सिकाउन तयार छु!',
      'नमस्ते दाजु! म भपुम हाजिर छु। केही नयाँ सिक्ने हो कि फोनको काम गर्ने?',
      'हजुर दाजु, म उपस्थित छु! कुनै प्रश्न सोध्नुहोस् वा आज्ञा गर्नुहोस्।',
    ];
    return {
      matched: true,
  ...
  if (
    ...
    const replies = [
      'नमस्ते दाजु! म एकदम सञ्चै, ऊर्जावान र सिक्न-सिकाउन तयार छु। तपाईंलाई कस्तो छ, आज के नयाँ विषय बुझौँ?',
      'नमस्कार! म भपुम तपाईंको सेवामा हरपल तयार छु। नेपाल, विज्ञान, गणित, लोकसेवा वा विश्वको कुनै पनि विषय सोध्नुहोस् दाजु!',
      'एकदम ठिकठाक छ दाजु! मलाई जुनसुकै गृहकार्य, प्रश्न वा फोनको काम भन्न सक्नुहुन्छ।',
    ];
    return {
      matched: true,
  ...
  if (
    ...
    return {
      matched: true,
      text: 'म भपुम (BHAPUMA), भरत पुन मगर दाजुले बनाउनुभएको १७ वर्षे सुपर-इन्टेलिजेन्ट नेपाली एआई असिस्टेन्ट तथा शिक्षक (Shikshya AI) हुँ। म नेपालको A to Z ज्ञान, विश्वको सम्पूर्ण जानकारी, पढाइ-लेखाइ, गणित, विज्ञान र फोन नियन्त्रण गर्न सक्दछु।',
    };
  }
  ...
  if (mathMatch) {
    ...
    if (!isNaN(result)) {
      return {
        matched: true,
        text: `${num1} ${op} ${num2} बराबर ${result} हुन्छ। गणितको कुनै पनि अन्य हिसाब भए सोध्न सक्नुहुन्छ दाजु!`,
      };
    }
  }
  ...
  if (lower.includes('धन्यवाद') || lower.includes('thank') || lower.includes('थ्यांक')) {
    return {
      matched: true,
      text: 'तपाईंलाई पनि धेरै धेरै धन्यवाद दाजु! म सधैं हजुरको सेवा, सिकाइ र मद्दतमा हाजिर छु।',
    };
  }
